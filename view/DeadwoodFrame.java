...
public class DeadwoodFrame extends JFrame {
  ...
  public void initDice(int playerCount) {
    ...
    label_p1 = new JLabel();
    ImageIcon icon1 = new ImageIcon(String.format(Controller.getPlayer(0).getBackground(), 1));
    if (flag) {
      icon1 = new ImageIcon(String.format(Controller.getPlayer(0).getBackground(), 2));
    }
    label_p1.setIcon(icon1);
    label_p2 = new JLabel();
    ImageIcon icon2 = new ImageIcon(String.format(Controller.getPlayer(1).getBackground(), 1));
    if (flag) {
      icon2 = new ImageIcon(String.format(Controller.getPlayer(1).getBackground(), 2));
    }
    ...
    if (playerCount >= 3) {
      label_p3 = new JLabel();
      ImageIcon icon3 = new ImageIcon(String.format(Controller.getPlayer(2).getBackground(), 1));
      if (flag) {
        icon3 = new ImageIcon(String.format(Controller.getPlayer(2).getBackground(), 2));
      }
    ...
    if (playerCount >= 4) {
      label_p4 = new JLabel();
      ImageIcon icon4 = new ImageIcon(String.format(Controller.getPlayer(3).getBackground(), 1));
      if (flag) {
        icon4 = new ImageIcon(String.format(Controller.getPlayer(3).getBackground(), 2));
      }
    ...
    if (playerCount >= 5) {
      label_p5 = new JLabel();
      ImageIcon icon5 = new ImageIcon(String.format(Controller.getPlayer(4).getBackground(), 1));
      if (flag) {
        icon5 = new ImageIcon(String.format(Controller.getPlayer(4).getBackground(), 2));
      }
    ...
    if (playerCount >= 6) {
      label_p6 = new JLabel();
      ImageIcon icon6 = new ImageIcon(String.format(Controller.getPlayer(5).getBackground(), 1));
      if (flag) {
        icon6 = new ImageIcon(String.format(Controller.getPlayer(5).getBackground(), 2));
      }
    ...
    if (playerCount >= 7) {
      label_p7 = new JLabel();
      ImageIcon icon7 = new ImageIcon(String.format(Controller.getPlayer(6).getBackground(), 2));
    ...
    if (playerCount == 8) {
      label_p8 = new JLabel();
      ImageIcon icon8 = new ImageIcon(String.format(Controller.getPlayer(7).getBackground(), 2));
