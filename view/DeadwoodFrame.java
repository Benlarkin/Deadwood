...
public class DeadwoodFrame extends JFrame {
  ...
  // place dice icons into trailers, add dice images to global array
  ...
  // side display for active player
  ...
  // place shotcounter images onto the board
  ...
  // reset all the shotcounters when day is over
  ...
  // move shot counter on successful act event
  ...
  // find which shotcount needs updating
  ...
  // update dice image on rank up
  public void updateActiveDice(int rank) {
    ImageIcon temp = new ImageIcon();
    switch (turn) {
    case 1:
      temp = new ImageIcon(String.format(P1DICE, rank));
      break;
    case 2:
      temp = new ImageIcon(String.format(P2DICE, rank));
      break;
    case 3:
      temp = new ImageIcon(String.format(P3DICE, rank));
      break;
    case 4:
      temp = new ImageIcon(String.format(P4DICE, rank));
      break;
    case 5:
      temp = new ImageIcon(String.format(P5DICE, rank));
      break;
    case 6:
      temp = new ImageIcon(String.format(P6DICE, rank));
      break;
    case 7:
      temp = new ImageIcon(String.format(P7DICE, rank));
      break;
    case 8:
      temp = new ImageIcon(String.format(P8DICE, rank));
      break;
    }
  ...
  public String getRoomInput(String[] adjacent) {
    try {
      String name = (String) JOptionPane.showInputDialog(this, ADJROOM, SELECTROOM, JOptionPane.QUESTION_MESSAGE, null,
          adjacent, adjacent[0]);
      return name;
    } catch (Exception e) {
      return null;
  ...
  public String getTakeInput(String[] roles) {
    try {
      String name = (String) JOptionPane.showInputDialog(this, VALIDROLES, SELECTROLES, JOptionPane.QUESTION_MESSAGE,
          null, roles, roles[0]);
      return name;
    } catch (Exception e) {
      return null;
  ...
  private String retryGetPlayerName(int playerNum) {
    String name = (String) JOptionPane.showInputDialog(this, ENTERNAME + playerNum + NEWLINE + ERRORNAME,
        PEELAYER + playerNum + NAME, JOptionPane.PLAIN_MESSAGE, null, null, null);
    if (name != null && name.length() > 0) {
      return name;
    }
  ...
  public String getDesiredCurrency() {
    try {
      ...
      String name = (String) JOptionPane.showInputDialog(this, DOLLORCRED, SELECTCURR, JOptionPane.QUESTION_MESSAGE,
  ...
  private String getPromoteRank(String[] options) {
    ...
    String desiredRank = (String) JOptionPane.showInputDialog(this, AFFORDABLEOPTION, CHOOSERANK,
